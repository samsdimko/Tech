...
namespace Samsonov_ProjectForTech
{
    public class Tree
    {
        ...
        public Tree(Graph GRAPH)
        {
            ...
            this.Height = GenerationNumber[0].Length * 40 + 40;
        ...
        private void DrawTree()
        {
            ...
            numberPrev = new int[3][];
            numberNext = new int[3][];
            for (int i = 0; i < graph[0].Length; i++)
            {
                ...
                while (graph[1][j] == graph[1][j - 1] || j == i)
                {
                    ...
                    graphics.DrawString(Dataset.GetPersonList()[graph[0][j]].GetName(), new System.Drawing.Font("Arial Black", 9, FontStyle.Regular, GraphicsUnit.Point), new SolidBrush(Color.Black), X + 5, Y + 2);
